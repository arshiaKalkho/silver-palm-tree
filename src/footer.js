            ...
            <div className = "footer container-fluid bg-light ">
                    ...
                    <div className="col-md-4">
                       <button type="button" class="btn">
                        <a href = "https://www.linkedin.com/in/arshia-kalkhorani/" target="_blank">
                    ...
                    <div className="col-md-4">
                        <button type="button" class="btn" >
                        <a href = "https://github.com/arshiaKalkho" target="_blank">
                    ...
                    <div className="col-md-4">
                        <button type="button" class="btn" >
                        <a href = "https://www.instagram.com/arshia_abdol/" target="_blank">
